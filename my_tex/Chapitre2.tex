...
%	Comme $C$ est un anneau, alors: \\
%	$x+y\in C$ d'où $A[x+y] \in C$.\\
%	De même $xy\in C$ alors $A[xy] \in C$\\
\end{proof}
...
%	Soit $I_1 \in \displaystyle \sum$, alors $I$ est une réduction de $I_1$ et $I$ est une réduction de $\hat{I}$. Ainsi d'après le Lemme précédent $I+I=I$ est une réduction de $I_1+\hat{I}$. Cela montre que $I_1+\hat{I} \in \displaystyle \sum$. Mais $\hat{I} \subset I_1+\hat{I}$ d'où $\hat{I} = I_1+\hat{I}$, par choix de $\hat{I}$ donc $I_1 \subset \hat{I}$. Ce qui achève la preuve.
%\end{proof} 
%\begin{moncorollaire}
%	Soient $A$ un anneau noethérien et $I$, $J$ deux idéaux de $A$. Si $I$ est une réduction de $J$, alors $\hat{I} = \hat{J}$.
%\end{moncorollaire}
%\begin{proof}
%	D'une part $I$ est une réduction de $J$ et $J$ est une réduction de $\hat{J}$ alors, d'après (1.1.2 Proposition) $I$ est une réduction de $\hat{J}$ par conséquent $\hat{J} \subset \hat{I}$, par le Théorème précédent. D'autre part $I \subset J \subset \hat{J} \subset \hat{I}$ et comme $I$ est une réduction de $\hat{I}$, alors il existe $n \in \mathbb{N^*}$ tel que $\hat{I}^{n+1} = I \hat{I}^n$.\\

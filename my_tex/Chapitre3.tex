...
\begin{proof}
	...
	$J_nX_n \subset R(A,g), \forall n \in \mathbb{N} \Rightarrow R(A,f) \subset R(A,g)$ car $f \leq g$,
	Donc $M \subset R(A,g)$.\\
	Montrons par récurrence que $\forall n \in \mathbb{N}, J_nX^n \subset M$
...
\begin{proof}
	...
	Alors $\exists N \in \mathbb{N^*}$ tel que $J^{N+1} = IJ^N$,\\ $I \subset J \Rightarrow I^n \subset J^n , \forall n \in \mathbb{N}$, d'où $f_I \leq f_J$.\\
	Posons $N_0 = N+1$ , \\
	Soit $n \geq N_0$ , \\
...
\begin{proof}
	...
	$f_I \leq g \Rightarrow \forall n \in \mathbb{N} , IJ_n \subset J_{n+1}$.\\
	Posons $N = 2N_0$\\
	Soit $n \geq N$, 
	\begin{align*}
...
\begin{proof}
	...
	Alors $I_{k_{n}^{\prime }m}\subset J_{k_{n}^{\prime }m}\subset
	J_{(k_{2k+n})m}=J_{k_{2k+n}}^{m}=J_{k}^{m}I_{k+n}^{m}\subset I_{n}^{m}.$
...
\begin{proof}
	...
	}}I_{q}M_{n-q}\subset \sum\limits_{q=1}^{N^{^{\prime \prime }}}I_{q}M_{n-q}
	$
...
\begin{proof}
	...
	et $I_{k_{n}m}\subset I_{n}^{m}$
	
	pour tout $m,n\in \mathbb{N}.$
	
	Par suite, $J_{(k_{n}+N)m}\subset J_{k_{n}m+Nm}\subset
	J_{k_{n}m+N}\subset I_{k_{n}m+N}\subset I_{k_{n}m}\subset
	I_{n}^{m}\subset J_{n}^{m}.$
	...
	Alors $I_{k_{n}^{\prime }+N.m}\subset J_{k_{n}^{\prime }+N.m}\subset
	J_{n+N}^{m}\subset I_{n}^{m}$ pour tout $m,n\in \mathbb{N}.$

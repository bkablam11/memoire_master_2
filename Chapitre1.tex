...
\begin{madefinition}
	...
	On appelle \textbf{anneau de Rees droit} de f, l'anneau gradué noté R(A,f) tel que: 
...
\begin{madefinition}
	...
	$G_{f}(A)=\displaystyle \bigoplus_{n \in \mathbb{Z}}{\frac{I_{n}}{I_{n+1}}} = \displaystyle \bigoplus_{n \in \mathbb{N}}{\frac{I_{n}}{I_{n+1}}} $
	
	$G_{\phi }(M)=\displaystyle \bigoplus_{n \in \mathbb{Z}}{\frac{M_{n}}{M_{n+1}}}$
	
	$G_{f}(A)$ est muni d'une structure d'anneau gradué dont la
	multiplication est définie par:
	
	Pour tout $a_{n}+I_{n+1},b_{p}+I_{p+1},$ deux éléments homogène
	de $G_{f}(A),$ On pose:
...
\begin{maproposition}
	...
	\begin{enumerate}
		...
		\item[(ii)] $R(A,f) \subseteq \mathcal{R}(A,f) \subseteq A[u,X]$ où $u = \dfrac{1}{X}$
		\item[(iii)] $u^n\mathcal{R}(A,f) \cap  A = I_n, \forall n \in \mathbb{Z}$
		\item[(iv)] $R(A,f) = A[I_1X,I_2X^2, \cdots, I_nX^n, \cdots] $
		\item[(v)] $u=\dfrac{1}{X} = X ^{-1}$ est régulier de degré -1 dans $\mathcal{R}(A,f)$ et on a: \[ \mathcal{R}(A,f) = A[u,I_1X,I_2X^2, \cdots, I_nX^n, \cdots ] \]
		\item[(vi)] $ \dfrac{R(A,I)}{IR(A,I)} \simeq G_I(A) $ avec $R(A,I) = R(A, f_I) $ et $G_I(A) = G_{f_{I}}(A) = \displaystyle \bigoplus_{n \in \mathbb{N}}{\frac{I^{n}}{I^{n+1}}} $
		\item[(vii)] $ \dfrac{\mathcal{R}(A,I)}{u\mathcal{R}(A,I)} \simeq G_I(A) $
		\item[(viii)] $ \dfrac{\mathcal{R}(A,I)}{(u-1)\mathcal{R}(A,I)} \simeq A $
	\end{enumerate} 
\end{maproposition}
...
\begin{madefinition}
	Soient $A$ un anneau et $I$ un idéal de A.\\
	La famille $f = (I^n)_{n\in \mathbb{Z}}$ telle que pour tout $n \leqslant 0, I^n = A$ est une filtration de A appelé \textbf{filtration I-adique} et noté $f_I$
\end{madefinition}
...
\subsubsection{c) \underline{Filtration tronqué d'ordre m de $f$}}
\begin{madefinition}
	Soient $A$ un anneau, $f = (I_n)_{n\in \mathbb{Z}}$ une filtration de l'anneau A.\\
	Soit $m$ un nombre entier naturel.\\
	On pose $t_{m}f=(K_n)$ avec $K_n = I_{n+m}$ si $n \geqslant 1 $ et $K_n = A$ si $n \leqslant 0$.\\
	Ainsi $t_{m}f$ est une filtration de $A$ appelé \textbf{filtration tronqué d'ordre m de $f$}.
\end{madefinition}
...
\begin{madefinition}
	La filtration $f = (I_n)_{n \in \mathbb{Z}}$ de l'anneau $A$ est dite \textbf{noethérienne} si $\mathcal{R}(A,f)$ est noethérien.
\end{madefinition}
